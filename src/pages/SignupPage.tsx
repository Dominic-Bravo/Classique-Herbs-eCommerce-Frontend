...
const SignupPage = () => {
  ...
  const [name, setName] = useState('Jane Customer');
  const [email, setEmail] = useState('jane@classique.test');
      ...
      <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Sample account creation page</p>
          </div>
        </div>
